      ...
      <div className="bg-[#003146] rounded-2xl">
        <div className="flex flex-col items-center gap-6 lg:flex-row-reverse lg:p-10">
          ...
          <div className="flex-1 text-center p-4 sm:p-6 md:p-8 lg:p-10">
            <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl text-[#F9F3EF] font-bold font-[philosopher] mb-6">
              My Educational Qualifications
            </h1>

            <div className="text-left space-y-2 flex flex-col justify-center items-center">
              <p className="pt-3 font-[philosopher] text-base sm:text-lg md:text-xl text-[#F9F3EF] flex items-center gap-3">
                BSc in Psychology <FaBrain />
              </p>
              <p className="font-[philosopher] text-base sm:text-lg md:text-xl text-[#F9F3EF] flex items-center gap-3">
